  ...
  <footer class="" aria-labelledby="footer-heading">
    ...
    <div class="px-5 py-12 mx-auto max-w-7xl lg:py-16 md:px-12 lg:px-20">
      <div class="xl:grid xl:grid-cols-3 xl:gap-8">
        <div class="space-y-8 xl:col-span-1">
          ...
          <p class="w-1/2 mt-2 text-sm text-gray-300">
            ...
            <div>
              ...
              <ul role="list" class="mt-4 space-y-4">
                <li>
                  <a
                    href="#"
                    class="text-sm font-normal text-gray-300 hover:text-red-500"
                  >
                    Marketing
                  </a>
                </li>
          ...
          <div class="hidden lg:justify-end md:grid md:grid-cols-1">
            <div class="w-full mt-12 md:mt-0">
              <div class="mt-8 lg:justify-end xl:mt-0">
                ...
                <p class="mt-4 text-sm text-gray-300 lg:ml-auto">
    ...
    >
      ...
      <div class="mt-8 md:mt-0 md:order-1">
        <span class="mt-2 text-sm font-light text-gray-300">
          Copyright © 2023
          <a
            href="https://darasa.tv"
            class="mx-2 hover:text-red-700"
